...
var GMap = {
    ...
    init: function () {
        ...
        //##### MARKERS ##### ***TEMP
        this.addMarker(uluru, "A");
        this.addMarker(uluru1, "B");
        this.addMarker(uluru2, "C");
    ...
    addMarker: function (location, letter) {
        var marker = new google.maps.Marker({
            position: location,
            map: this.map,
            draggable: true,
